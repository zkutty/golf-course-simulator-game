...
- The overlay/summary builder remains deferred in the 12.24 kB planner chunk. Deterministic 36-hole work is capped at 108 segments, 72 landing zones, 320 traces, and 180 points; `test:zk764:perf` enforces the 3-second wall-clock budget in an isolated one-worker benchmark. Full Vitest, focused browser regressions, TypeScript, lint/i18n, and production build/audits pass; initial JavaScript is 1,608,494 bytes, 225 bytes under the fixed ceiling.
