...
export function buildGolfopediaEntries(t: Translator): readonly GolfopediaEntry[] {
  ...
  const management = ["rating", "tournaments", "demand", "cash", "reputation", "condition", "architecture", "routing", "naturalFit", "walkability", "safety", "estateAccess", "practiceAcademy", "clubCampus"] as const;
