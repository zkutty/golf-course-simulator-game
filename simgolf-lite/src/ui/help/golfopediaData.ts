...
export function buildGolfopediaEntries(
  ...
  const management = ["rating", "tournaments", "demand", "cash", "reputation", "condition", "architecture", "strategicArchitecture", "routing", "naturalFit", "walkability", "safety", "estateAccess", "practiceAcademy", "clubCampus"] as const;
