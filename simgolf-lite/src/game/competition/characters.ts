...
const PACKAGES: readonly OccupationPackage[] = [
  ...
  ["host", "card-dealer-casino-host", "Deals private card nights and hosts licensed local events.", "A regular taught the game after late shifts.", "Enjoys negotiated stakes without hidden terms.", "Unflappable, sociable, and scrupulous about settlement.", "fierce", 88, "Pressure Putting", undefined, ["skins", "nassau"], ["vehicle", "watch", "keepsake"], "midnight-coupe", { id: "reward-midnight-coupe", name: "Midnight Coupe", itemDefinitionId: "midnight-coupe" }],
