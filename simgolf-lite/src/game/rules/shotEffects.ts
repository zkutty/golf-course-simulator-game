...
export { DISPERSION_CLUBS as SHOT_CLUBS } from "./dispersionRegistry";
export type { ShotClubDefinition, ShotClubFamily, ShotClubId, ShotTechnique } from "./dispersionRegistry";
