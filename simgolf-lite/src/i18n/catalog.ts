...
export const en = {
  ...
  "vision.biomes.body": "The same CourseCraft promise can live among volcanic coasts, wooded hills, high-country valleys, inland heath, or the firm pale sand of a Sandbelt course. Each setting changes the land, the light, and the way a round feels.",
