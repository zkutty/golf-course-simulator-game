...
export const en = {
  ...
  "vision.hero.deck": "A cozy golf management game where every contour, clubhouse wing, golfer story, and hard-earned reputation belongs to you.",
  ...
  "vision.story.body": "CourseCraft is the fantasy of growing a patch of promising land into a golf world with history. Design holes worth remembering, welcome distinct golfers, operate the club behind the scorecard, and watch every choice ripple across the estate.",
